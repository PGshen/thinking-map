...
- AI 辅助工具：Cursor + Trae
  - 使用方式：用 Cursor 驱动局部代码生成与重构，用 Trae 做项目级语义检索与跨文件联动；
  - 心得：工具非常有用，但“上下文工程”的质量决定了输出质量——必须用结构化文档压住提示词的随意性。
...
第二篇将分享我在 Cursor、Copilot、Trae 等 AI 编程工具上的真实体验：从期待到现实的落差、如何调整协作方式、以及在实际开发中总结出的提示工程与代码审查技巧。