...
func WithToolOptions(opts ...tool.Option) AgentOption {
	return WithComposeOptions(compose.WithToolsNodeOption(compose.WithToolOption(opts...)))
}
...
func WithChatModelOptions(opts ...model.Option) AgentOption {
	return WithComposeOptions(compose.WithChatModelOption(opts...))
}
...
func WithToolList(tools ...tool.BaseTool) AgentOption {
	return WithComposeOptions(compose.WithToolsNodeOption(compose.WithToolList(tools...)))
}

type Iterator[T any] struct {
	ch *UnboundedChan[item[T]]
}
...
func WithMessageFuture() (AgentOption, MessageFuture) {
	...
	option := WithComposeOptions(compose.WithCallbacks(cb))
...
type cbHandler struct {
	msgs  *UnboundedChan[item[*schema.Message]]
	sMsgs *UnboundedChan[item[*schema.StreamReader[*schema.Message]]]
...
func (h *cbHandler) onGraphStart(ctx context.Context,
	...
	h.msgs = NewUnboundedChan[item[*schema.Message]]()
...
func (h *cbHandler) onGraphStartWithStreamInput(ctx context.Context, _ *callbacks.RunInfo,
	...
	h.sMsgs = NewUnboundedChan[item[*schema.StreamReader[*schema.Message]]]()
