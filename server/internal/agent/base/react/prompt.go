...
**After tool call results**:
{
  ...
  "action": "final_answer",
  "final_answer": "According to the latest data, today's weather is sunny, temperature 22-28°C, humidity 65%, southeast wind level 3, suitable for outdoor activities.",
  "confidence": 0.95
}
