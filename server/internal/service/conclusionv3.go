...
import (
	...
	"github.com/PGshen/thinking-map/server/internal/agent/conclusionv3"
...
type ConclusionV3Service struct {
	contextManager *ContextManager
	msgManager     *global.MessageManager
	nodeRepo       repository.ThinkingNode
}

func NewConclusionV3Service(contextManager *ContextManager, nodeRepo repository.ThinkingNode) *ConclusionV3Service {
	return &ConclusionV3Service{
		contextManager: contextManager,
...
func (c *ConclusionV3Service) Conclusion(ctx *gin.Context, req dto.ConclusionRequest) (sr *schema.StreamReader[*schema.Message], err error) {
	// 查询上下文
...
func (c *ConclusionV3Service) Generate(ctx *gin.Context, contextInfo *ContextInfo, messages []*schema.Message) (sr *schema.StreamReader[*schema.Message], err error) {
...
func (c ConclusionV3Service) Optimize(ctx *gin.Context, messages []*schema.Message) (sr *schema.StreamReader[*schema.Message], err error) {
