...
require (
	...
	github.com/cloudwego/eino-ext/components/model/deepseek v0.0.0-20250624023530-68a1e4282a8e
...
require (
	...
	github.com/cloudwego/eino-ext/components/tool/googlesearch v0.0.0-20250626134119-cf4f96ea0039 // indirect
