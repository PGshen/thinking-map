...
// SSE事件类型定义
type SSEEventType = 'nodeCreated' | 'nodeUpdated' | 'connection_established' | 'messageText' | 'messageThought' | 'messageNotice' | 'messageAction' | 'messagePlan' | 'error' | 'ping' | 'message';
